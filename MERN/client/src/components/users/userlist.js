...
class UserList extends Component {
  ...
  onchatnowClick(id, status) {
    window.localStorage.setItem('chat_head_status', status);
    console.log(status);
          ...
          <div className="media">
            ...
            <div className="media-body">
             ...
             {  
              ...
              <p>
                <a href='javascript:void(0)' onClick={ e => this.onchatnowClick(obj._id, obj.user_status)}   className="btn btn-xs btn-default"><span className="glyphicon glyphicon-comment"></span> Chat</a>
